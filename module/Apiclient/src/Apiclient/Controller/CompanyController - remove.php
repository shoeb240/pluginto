...
class CompanyController extends ApiclientActionController
{
    ...
    public function addAction()
    {
        ...
        if ($this->request->isPost()) {
            $createData = array('user_id' => $this->getRequest()->getPost('user_id'),
                                ...
                                'company_type' => $this->getRequest()->getPost('company_type'));
    ...
    public function editAction()
    {
        ...
        if ($this->request->isPost()) {
            $updatedData = array('user_id' => $this->getRequest()->getPost('user_id'),
                                'company_name' => $this->getRequest()->getPost('company_name'),
                                'display_name' => $this->getRequest()->getPost('display_name'),
                                'name' => $this->getRequest()->getPost('name'),
                                'surname' => $this->getRequest()->getPost('surname'),
    ...
    private function prepareApi(Request $request)
    {
        ...
        $routeMatch       = new \Zend\Mvc\Router\RouteMatch(array('controller' => 'input', 'input-type' => 'vendor', 'user_id' => $this->getUserId()));
